...
public class winBG {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 1082, 591);
		...
		if (PhieuXuatList != null) {
			for (int i = 0;i < PhieuXuatList.size();i++) {
				row4[0] = PhieuXuatList.get(i).getMaPN();
				row4[1] = PhieuXuatList.get(i).getNgayLapPN();
		...
		panel.setBounds(166, 0, 926, 552); // Danh sách sản phẩm 
		panel_1.setBounds(166, 0, 926, 552); // Background color
		panel_2.setBounds(166, 0, 926, 552);
		panel_3.setBounds(166, 0, 926, 552);   //Nhập kho Xuất kho
		panel_4.setBounds(0, 0, 165, 500); //menu
		panel_5.setBounds(0, 0, 1081, 552);   // phần đăng nhập
		panel_6.setBounds(0, 0, 1081, 552); // admin
		panel_7.setBounds(166, 0, 926, 552); // danh sách phieu xuất
		...
		lblNewLabel_1.setBounds(10, 13, 82, 49);
		lblNewLabel_1.setForeground(new Color(255, 255, 255));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		panel_3.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_4 = new JLabel("Ngày ");
		lblNewLabel_1_4.setBounds(10, 75, 82, 49);
		...
		lblNewLabel_1_5.setBounds(412, 11, 105, 51);
		...
		lblNewLabel_1_6.setBounds(412, 75, 82, 49);
		...
		MaPhieu.setFont(new Font("Tahoma", Font.PLAIN, 18));
		MaPhieu.setBounds(94, 13, 213, 49);
		panel_3.add(MaPhieu);
		MaPhieu.setColumns(10);
		
		Ngay = new JTextField();
		Ngay.setFont(new Font("Tahoma", Font.PLAIN, 18));
		Ngay.setBounds(94, 75, 213, 49);
		Ngay.setColumns(10);
		panel_3.add(Ngay);
		...
		SoluongB.setFont(new Font("Tahoma", Font.PLAIN, 18));
		...
		btnNewButton_1.setBounds(653, 91, 115, 48);
		...
		btnNewButton.setBounds(653, 19, 115, 48);
		...
		lblNewLabel_1_4_1.setBounds(10, 135, 82, 49);
		panel_3.add(lblNewLabel_1_4_1);
		
		JRadioButton rdbtnNewRadioButton = new JRadioButton("Nhập Kho");
		rdbtnNewRadioButton.setForeground(new Color(255, 255, 255));
		rdbtnNewRadioButton.setBackground(new Color(64, 100, 128));
		rdbtnNewRadioButton.setFont(new Font("Tahoma", Font.PLAIN, 14));
		rdbtnNewRadioButton.setBounds(94, 135, 105, 49);
		panel_3.add(rdbtnNewRadioButton);
		
		JRadioButton rdbtnXutKho = new JRadioButton("Xuất Kho");
		rdbtnXutKho.setForeground(new Color(255, 255, 255));
		rdbtnXutKho.setBackground(new Color(64, 100, 128));
		rdbtnXutKho.setFont(new Font("Tahoma", Font.PLAIN, 14));
		rdbtnXutKho.setBounds(209, 135, 98, 49);
		panel_3.add(rdbtnXutKho);
		
		
		JButton btnNewButton_1_1 = new JButton("Xóa SP");
		btnNewButton_1_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnNewButton_1_1.setBounds(778, 91, 112, 48);
		...
		btnNewButton_1_2.setBounds(778, 19, 112, 48);
		...
		btnNewButton_1_1_1.setBounds(653, 149, 112, 48);
		...
		btnNewButton_2_1_1_2.setFont(new Font("Tahoma", Font.PLAIN, 19));
		...
		btnNewButton_2_1_1_2.setBounds(8, 5, 141, 45);
		panel_4.add(btnNewButton_2_1_1_2);
		
		JButton btnNewButton_2_1_1_1_1_1_2 = new JButton("Nhập Phiếu");
		btnNewButton_2_1_1_1_1_1_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		...
		btnNewButton_2_1_1_1_1_1_2.setBounds(8, 173, 141, 45);
		panel_4.add(btnNewButton_2_1_1_1_1_1_2);
		
		JButton btnNewButton_2_1_1_1_1_1_1_1 = new JButton("Phiếu Nhập");
		btnNewButton_2_1_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 19));
		...
		btnNewButton_2_1_1_1_1_1_1_1.setBounds(8, 117, 141, 45);
		panel_4.add(btnNewButton_2_1_1_1_1_1_1_1);
		
		
		JButton btnNewButton_2_1_1_1_1_1_1_1_1 = new JButton("Đăng Xuất");
		btnNewButton_2_1_1_1_1_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 19));
		...
		btnNewButton_2_1_1_1_1_1_1_1_1.setBounds(8, 226, 141, 45);
		panel_4.add(btnNewButton_2_1_1_1_1_1_1_1_1);
		
		JButton btnNewButton_2_1_1_1_1_1_2_1 = new JButton("Phiếu Xuất");
		...
		btnNewButton_2_1_1_1_1_1_2_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		btnNewButton_2_1_1_1_1_1_2_1.setBounds(8, 61, 141, 45);
		...
		btnNewButton_3.setBounds(399, 279, 258, 41);
		panel_5.add(btnNewButton_3);
		
		Username_text = new JTextField();
		Username_text.setBounds(392, 102, 265, 30);
		panel_5.add(Username_text);
		Username_text.setColumns(10);
		
		JLabel lblNewLabel = new JLabel("UserName");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel.setBounds(318, 106, 69, 30);
		panel_5.add(lblNewLabel);
		
		JLabel lblNewLabel_2 = new JLabel("Password");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel_2.setBounds(318, 147, 69, 30);
		panel_5.add(lblNewLabel_2);
		
		passwordField = new JPasswordField(16);
		passwordField.setBounds(392, 148, 265, 30);
