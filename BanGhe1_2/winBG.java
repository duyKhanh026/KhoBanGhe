...
public class winBG {
	...
	private void initialize() {
		...
		panel_3.setBounds(0, 28, 926, 552);
		...
		if (!adminP) {
			...
			btnNewButton_1_2.setBounds(653, 78, 115, 48);
		}
		...
		m2 = new JMenuItem("Import excel", icon1);
		m3 = new JMenuItem("Export excel", icon2);
		menu = new JMenu("File");
